...
retry_duration:
    ...
    if (st->codecpar->codec_id == AV_CODEC_ID_AAC ||
        ...
        if (st->codecpar->codec_id == AV_CODEC_ID_H264 || st->codecpar->codec_id == AV_CODEC_ID_HEVC || st->codecpar->codec_id == AV_CODEC_ID_VVC || st->codecpar->codec_id == AV_CODEC_ID_MPEG4) {
            // sign extension
        ...
        if (type == 0 && (!st->codecpar->extradata || st->codecpar->codec_id == AV_CODEC_ID_AAC ||
            st->codecpar->codec_id == AV_CODEC_ID_H264 || st->codecpar->codec_id == AV_CODEC_ID_HEVC || st->codecpar->codec_id == AV_CODEC_ID_VVC)) {
            AVDictionaryEntry *t;
